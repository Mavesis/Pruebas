      ...
      stage('ANALYSIS '){
        steps{
          ...
          withSonarQubeEnv('local_sonar'){
            ...
            bat 'C:/sonar-scanner/bin/sonar-scanner.bat -X -Dsonar.projectKey=ProyectoIvi -Dsonar.organization=Manu -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=39acfca66c299343b8ac4427b69b5cb78db97cf1 -Dsonar.branch.name='+BRANCH_NAME
          }
        }
      }
  }
